...
require (
	...
	github.com/NpoolPlatform/inspire-middleware v0.0.0-20231121062656-445018a9233b
	...
	github.com/NpoolPlatform/order-middleware v0.0.0-20231115110533-59117fa2a2d9
