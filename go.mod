...
require (
	...
	github.com/NpoolPlatform/good-middleware v0.0.0-20230905075718-a4cefe1bff92
	...
	github.com/NpoolPlatform/order-middleware v0.0.0-20230905020518-f7a7139425b8
