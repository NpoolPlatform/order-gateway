...
[![Test](https://github.com/NpoolPlatform/order-gateway/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/order-gateway/actions/workflows/main.yml)
...
* make order-gateway ```单独编译服务```
* make order-gateway-image ```单独生成服务镜像```
